...
export const CalendarTutor = ({ id = 0 }: Props) => {
  ...
  // hàm kiểm tra thời gian có nằm trong 24h tính từ thời gian tạo lịch hay không
  const IsButtonDisabled = () => {
    let diff = moment().diff(moment(state?.startTime), "hours");
    if (diff <= 24) {
      return false;
    } else {
      return true;
